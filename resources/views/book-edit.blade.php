    ...
    <div class="book-edit mt-3 w-50">
        ...
        <form action="/book-edit/{{ $book->slug }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                @if ($book->cover !='')
                    <img src="{{ asset('storage/cover/'.$book->cover) }}" alt="" width="100px" height="120px">
                @else
                    <img src="{{ asset('image/no_cover.jpg') }}" alt="" width="100px" height="120px">
                @endif
            </div>
